...
def saveResult(save_path, npyfile, flag_multi_class=False, num_class=2):
    for i, item in enumerate(npyfile):
        ...
        #io.imsave(os.path.join(save_path, "%d_predict.png" % i), img, check_contrast=False, as_gray=False)




#new---------------------------------------
def testGenerator2(test_img, target_size = (256,256), flag_multi_class = False):
...
def saveResult2(frame, flag_multi_class=False, num_class=2):
